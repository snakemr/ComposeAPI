...
fun Lesson01(spiderMan: TP) {
    ...
    Text("""Урок 1. Вывод на экран по условию  
      
    Нужно вывести на экран либо трейлер, либо постер фильма, который дан в параметрах этой функции. 
    ...
    А текстовый элемент, который вы читаете, нужно, разумеется, удалить.""".trimIndent())
